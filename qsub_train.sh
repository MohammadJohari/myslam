...
#    output="/idiap/temp/mjohari/outputs/slam/CVPR_4/Replica/${room}/ours_${i}"
#    python_command="run.py configs/Replica/${room}.yaml --input_folder ${input_folder} --output ${output}"
    ...
    output="/idiap/temp/mjohari/outputs/slam/CVPR_4/ScanNet/${room}/ours_${i}"
